...
$Query2="select count(*) from products where product_id='$product_id'";
...
{ 
    ...
    if ($conn->query($sql) == TRUE) {
        echo '<div>
    <h1 style="color: #9C1A1A;font-size:40px; font-family: "Roboto", sans-serif;margin:auto;">Data deleted successfully</h1>
       </div>';
    } else {
...
?>
<form>
    <button type="submit" class="backbutton" formaction="products.php">Back</button>
</form>
<body>
<html>