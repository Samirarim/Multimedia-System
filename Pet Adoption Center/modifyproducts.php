...
if ($conn->connect_error) {
  ...
  $Query2="select count(*) from products where product_id='$id'";
  $Execute = mysqli_query($conn,$Query2);
  $count = mysqli_fetch_row($Execute);

  if($count[0]=true)
  {
    $sql = "UPDATE products SET product_name='$name',product_price='$price',product_quantity='$quantity' WHERE product_id='$id'";
