...
<button class="button addbutton" type="submit" formaction="addpets.php">Add Pets Information</button>
<button class="button updatebutton" type="submit"  formaction="modifypets.php">Modify Pets Information</button>
</form>
</div>
  <?php
