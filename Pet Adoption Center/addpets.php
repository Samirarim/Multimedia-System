...
<form method="post" action="addpets.php" >  
<fieldset>
  ...
  <input type="number" step=any name="pet_height"  placeholder="Enter height" style="width:280px;height:30px;
   border: 2px solid  #9C190A; border-radius:3px;background:transparent;" min="5" required>
  <br><br>
...
$sql = "INSERT INTO pets( pet_id,pet_category,pet_breed,pet_height,pet_weight,pet_fur)
VALUES ('$id','$category','$breed','$height','$weight','$fur')";
