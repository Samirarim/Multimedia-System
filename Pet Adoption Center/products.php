...
<button class="button addbutton" type="submit" formaction="addproducts.php">Add Products Information</button>
<button class="button updatebutton" type="submit"  formaction="modifyproducts.php">Modify Products Information</button>
</form>
</div>
  <?php
